                    ...
                    <div class="d-flex gap-2 flex-wrap img-switch">
                        ...
                        <!-- <div class="form-check sidebar-setting card-radio">
                            ...
                            <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-01">
                                <img src="<?= base_url('assets/images/sidebar/img-1.png'); ?>" alt="Sidebar image"
                        ...
                        <!-- <div class="form-check sidebar-setting card-radio">
                            ...
                            <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-02">
                                <img src="<?= base_url('assets/images/sidebar/img-2.jpg'); ?>" alt="Sidebar image"
                                    class="avatar-md w-auto object-fit-cover" />
                            </label>
                        </div> -->
                        <div class="form-check sidebar-setting card-radio">
                            ...
                            <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-03">
                                <img src="<?= base_url('assets/images/sidebar/img-3.jpg'); ?>" alt=""
                                    class="avatar-md w-auto object-fit-cover" />
                            </label>
                        </div>
                        <div class="form-check sidebar-setting card-radio">
                            ...
                            <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-04">
                                <img src="<?= base_url('assets/images/sidebar/img-4.jpg'); ?>" alt=""
                                    class="avatar-md w-auto object-fit-cover" />
                            </label>
                        </div>
                        <!-- <div class="form-check sidebar-setting card-radio">
                            <input class="form-check-input" type="radio" name="data-sidebar-image" id="sidebarimg-05"
                                value="img-" />
                            <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-05">
                                <img src="<?= base_url('assets/images/barangay.png'); ?>" alt=""
                                    class="avatar-md w-auto object-fit-cover" />
                            </label>
                        </div> -->
                    </div>
